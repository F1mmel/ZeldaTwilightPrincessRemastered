...
namespace JStudio.J3D.Animation
{
    public class BRK : BaseJ3DAnimation
    {
        ...
        public List<RegisterAnim> GetColorAnimationData()
        {
            return m_colorAnimationData;
        }

        public List<RegisterAnim> GetKonstAnimationData()
        {
            return m_konstAnimationData;
        }
        ...
        public void ApplyFrame(MAT3 pose, Material[] materials, int frame)
        {
            float ftime = frame;
            ...
            for (int i = 0; i < m_colorAnimationData.Count; i++)
            {
                ...
                mat.TevColorIndexes[m_colorAnimationData[i].ColorID] = new WLinearColor(newR, newG, newB, newA);
                //materials[i].SetColor("_MainColor", new Color(newR, newG, newB, newA));
                materials[i].SetColor("_BaseColor", new Color(newR, newG, newB, newA));
            }
            ...
            for (int i = 0; i < m_konstAnimationData.Count; i++)
            {
                ...
                mat.TevKonstColorIndexes[m_konstAnimationData[i].ColorID] = new WLinearColor(newR, newG, newB, newA);
            }
        }
